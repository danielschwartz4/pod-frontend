...
export type RegularPodFragment = {
  __typename?: "Pod";
  id: number;
  cap: number;
...
export type RegularProjectFragment = {
  ...
  milestoneProgress: Array<number>;
  groupSize: number;
  createdAt: any;
  updatedAt: any;
  overview: string;
...
export type UpdateProjectGroupSizeMutation = {
  __typename?: "Mutation";
...
export type UpdateProjectMilestoneDatesMutation = {
  __typename?: "Mutation";
...
`;
export type UpdatePhoneMutationFn = Apollo.MutationFunction<
  UpdatePhoneMutation,
...
export function useUpdatePhoneMutation(
  ...
  return Apollo.useMutation<UpdatePhoneMutation, UpdatePhoneMutationVariables>(
    UpdatePhoneDocument,
    options
  );
}
export type UpdatePhoneMutationHookResult = ReturnType<
  typeof useUpdatePhoneMutation
>;
export type UpdatePhoneMutationResult =
  Apollo.MutationResult<UpdatePhoneMutation>;
export type UpdatePhoneMutationOptions = Apollo.BaseMutationOptions<
  UpdatePhoneMutation,
  UpdatePhoneMutationVariables
>;
...
export const UpdateProjectGroupSizeDocument = gql`
  mutation UpdateProjectGroupSize(
    $groupSize: Float!
    $updateProjectGroupSizeId: Float!
  ) {
    updateProjectGroupSize(
      groupSize: $groupSize
      id: $updateProjectGroupSizeId
    ) {
      errors
      project {
        ...RegularProject
  ...
  ${RegularProjectFragmentDoc}
`;
export type UpdateProjectGroupSizeMutationFn = Apollo.MutationFunction<
  UpdateProjectGroupSizeMutation,
  UpdateProjectGroupSizeMutationVariables
>;
 ...
 * });
 */
export function useUpdateProjectGroupSizeMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateProjectGroupSizeMutation,
    UpdateProjectGroupSizeMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdateProjectGroupSizeMutation,
    UpdateProjectGroupSizeMutationVariables
  >(UpdateProjectGroupSizeDocument, options);
}
export type UpdateProjectGroupSizeMutationHookResult = ReturnType<
  typeof useUpdateProjectGroupSizeMutation
>;
export type UpdateProjectGroupSizeMutationResult =
  Apollo.MutationResult<UpdateProjectGroupSizeMutation>;
export type UpdateProjectGroupSizeMutationOptions = Apollo.BaseMutationOptions<
  UpdateProjectGroupSizeMutation,
  UpdateProjectGroupSizeMutationVariables
>;
export const UpdateProjectMilestoneDatesDocument = gql`
  mutation UpdateProjectMilestoneDates(
    $milestoneDates: [String!]!
    $updateProjectMilestoneDatesId: Float!
  ) {
    updateProjectMilestoneDates(
  ...
  ${RegularProjectFragmentDoc}
`;
export type UpdateProjectMilestoneDatesMutationFn = Apollo.MutationFunction<
  UpdateProjectMilestoneDatesMutation,
  UpdateProjectMilestoneDatesMutationVariables
>;
 ...
 * });
 */
export function useUpdateProjectMilestoneDatesMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateProjectMilestoneDatesMutation,
    UpdateProjectMilestoneDatesMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdateProjectMilestoneDatesMutation,
    UpdateProjectMilestoneDatesMutationVariables
  >(UpdateProjectMilestoneDatesDocument, options);
}
export type UpdateProjectMilestoneDatesMutationHookResult = ReturnType<
  typeof useUpdateProjectMilestoneDatesMutation
>;
export type UpdateProjectMilestoneDatesMutationResult =
  Apollo.MutationResult<UpdateProjectMilestoneDatesMutation>;
export type UpdateProjectMilestoneDatesMutationOptions =
...
export const UpdateProjectMilestonesDocument = gql`
  ...
  ${RegularProjectFragmentDoc}
`;
export type UpdateProjectMilestonesMutationFn = Apollo.MutationFunction<
  UpdateProjectMilestonesMutation,
  UpdateProjectMilestonesMutationVariables
>;
 ...
 * });
 */
export function useUpdateProjectMilestonesMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateProjectMilestonesMutation,
    UpdateProjectMilestonesMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdateProjectMilestonesMutation,
    UpdateProjectMilestonesMutationVariables
  >(UpdateProjectMilestonesDocument, options);
}
export type UpdateProjectMilestonesMutationHookResult = ReturnType<
  typeof useUpdateProjectMilestonesMutation
>;
export type UpdateProjectMilestonesMutationResult =
  Apollo.MutationResult<UpdateProjectMilestonesMutation>;
export type UpdateProjectMilestonesMutationOptions = Apollo.BaseMutationOptions<
  UpdateProjectMilestonesMutation,
  UpdateProjectMilestonesMutationVariables
>;
...
export const UpdateProjectProgressDocument = gql`
  ...
  ${RegularProjectFragmentDoc}
`;
export type UpdateProjectProgressMutationFn = Apollo.MutationFunction<
  UpdateProjectProgressMutation,
  UpdateProjectProgressMutationVariables
>;
...
export function useUpdateProjectProgressMutation(
  ...
  return Apollo.useMutation<
    UpdateProjectProgressMutation,
    UpdateProjectProgressMutationVariables
  >(UpdateProjectProgressDocument, options);
}
export type UpdateProjectProgressMutationHookResult = ReturnType<
  typeof useUpdateProjectProgressMutation
>;
export type UpdateProjectProgressMutationResult =
  Apollo.MutationResult<UpdateProjectProgressMutation>;
export type UpdateProjectProgressMutationOptions = Apollo.BaseMutationOptions<
  UpdateProjectProgressMutation,
  UpdateProjectProgressMutationVariables
>;
 ...
 * });
 */
export function usePodProjectsQuery(
  baseOptions: Apollo.QueryHookOptions<
    PodProjectsQuery,
    PodProjectsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<PodProjectsQuery, PodProjectsQueryVariables>(
    PodProjectsDocument,
    options
  );
}
export function usePodProjectsLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<PodProjectsQuery, PodProjectsQueryVariables>(
    PodProjectsDocument,
    options
  );
}
export type PodProjectsQueryHookResult = ReturnType<typeof usePodProjectsQuery>;
export type PodProjectsLazyQueryHookResult = ReturnType<
  typeof usePodProjectsLazyQuery
>;
export type PodProjectsQueryResult = Apollo.QueryResult<
  PodProjectsQuery,
  PodProjectsQueryVariables
>;
...
export function usePodsQuery(
  baseOptions?: Apollo.QueryHookOptions<PodsQuery, PodsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function usePodsLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<PodsQuery, PodsQueryVariables>(
    PodsDocument,
    options
  );
}
